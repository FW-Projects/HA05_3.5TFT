...
/**
  * @brief tmr dma system_parameter address type
  */
typedef enum
{
  TMR_CTRL1_ADDRESS                      = 0x0000, /*!< tmr dma system_parameter address ctrl1 */
  TMR_CTRL2_ADDRESS                      = 0x0001, /*!< tmr dma system_parameter address ctrl2 */
  TMR_STCTRL_ADDRESS                     = 0x0002, /*!< tmr dma system_parameter address stctrl */
  TMR_IDEN_ADDRESS                       = 0x0003, /*!< tmr dma system_parameter address iden */
  TMR_ISTS_ADDRESS                       = 0x0004, /*!< tmr dma system_parameter address ists */
  TMR_SWEVT_ADDRESS                      = 0x0005, /*!< tmr dma system_parameter address swevt */
  TMR_CM1_ADDRESS                        = 0x0006, /*!< tmr dma system_parameter address cm1 */
  TMR_CM2_ADDRESS                        = 0x0007, /*!< tmr dma system_parameter address cm2 */
  TMR_CCTRL_ADDRESS                      = 0x0008, /*!< tmr dma system_parameter address cctrl */
  TMR_CVAL_ADDRESS                       = 0x0009, /*!< tmr dma system_parameter address cval */
  TMR_DIV_ADDRESS                        = 0x000A, /*!< tmr dma system_parameter address div */
  TMR_PR_ADDRESS                         = 0x000B, /*!< tmr dma system_parameter address pr */
  TMR_RPR_ADDRESS                        = 0x000C, /*!< tmr dma system_parameter address rpr */
  TMR_C1DT_ADDRESS                       = 0x000D, /*!< tmr dma system_parameter address c1dt */
  TMR_C2DT_ADDRESS                       = 0x000E, /*!< tmr dma system_parameter address c2dt */
  TMR_C3DT_ADDRESS                       = 0x000F, /*!< tmr dma system_parameter address c3dt */
  TMR_C4DT_ADDRESS                       = 0x0010, /*!< tmr dma system_parameter address c4dt */
  TMR_BRK_ADDRESS                        = 0x0011, /*!< tmr dma system_parameter address brake */
  TMR_DMACTRL_ADDRESS                    = 0x0012  /*!< tmr dma system_parameter address dmactrl */
