                             ...
                             uint32_t pic_size)
{
    ...
    case 4:
        uiPic_Addr = Flash_Pic4_Addr;
        break;

    case 5:
        uiPic_Addr = Flash_Pic5_Addr;
        break;

    case 6:
        uiPic_Addr = Flash_Pic6_Addr;
        break;

    case 7:
        uiPic_Addr = Flash_Pic7_Addr;
        break;

    case 8:
        uiPic_Addr = Flash_Pic8_Addr;
        break;

    case 9:
        uiPic_Addr = Flash_Pic9_Addr;
        break;

    case 10:
        uiPic_Addr = Flash_Pic10_Addr;
        break;
...
/******************************************************************************
      ...
      返回值：  无
******************************************************************************/
void DrawProgressBar(u16 x1, u16 y1, u16 x2, u16 y2, u8 scale, u16 bar_color, u16 bc_color, const u8 pic[])
{
    if (scale >= 100)
    {
        scale = 100;
    ...
    LCD_Fill(x1, y1, x2, y1 + len, bc_color);
    LCD_Fill(x1, y1 + len, x2, y2, bar_color);
    LCD_ShowPicture(x1, (y1 + len), 12, 14, pic);
}
